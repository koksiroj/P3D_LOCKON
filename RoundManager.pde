class RoundManager {
  ...
  void SetAllCharacters() {
    ...
    CharacterPool[0] = new Character("MermanLowP.obj", new CharacterAspect[] {CharacterAspect.POSH, CharacterAspect.FIT});
    CharacterPool[1] = new Character("ShrromGirl.obj", new CharacterAspect[] {CharacterAspect.FASHIONABLE});
